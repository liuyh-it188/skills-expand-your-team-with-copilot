document.addEventListener("DOMContentLoaded", () => {
  ...
  function createShareUrl(activityName, details) {
    const formattedSchedule = formatSchedule(details);
    const baseUrl = window.location.origin + window.location.pathname;
    return {
      url: baseUrl,
      text: `Check out ${activityName} at Mergington High School! ${details.description} - Schedule: ${formattedSchedule}`,
      title: activityName,
  ...
  function shareOnTwitter(activityName, details) {
    const shareData = createShareUrl(activityName, details);
